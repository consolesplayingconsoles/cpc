...
export interface NodeData {
  ...
  send?:  boolean         // takes games from the Media tab (a catalogue send strategy: PS2 drive, SD card)
  sendSystems?: string[] | null  // SD_SEND_SYSTEMS — only these of its systems; null = all it hosts
