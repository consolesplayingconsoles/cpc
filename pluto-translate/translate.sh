...
for rel in STORY.PAC S18RM04.FON DOUGU/ITEMTBL.PAC DEFMENU.SCP MAINMENU.SCP MAP.SCP NOBIMAP.SCP 1ST_READ.BIN INFO/DORADO.TBL INFO/SECRET.TBL DPETC/MESSAGE.INI; do
